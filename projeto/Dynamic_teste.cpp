...
vector<double> dinamic_h(vector<double> Px, vector<double> Py)
{
    vector<double> h;
    int n = Px.size();
...
static void DrawCurve(double b0x,double b0y,	// De Casteljau Algorithm
...
static void Redraw(void)
{
    ...
    {
     DrawCurve(x[i],y[i],Rx[i],Ry[i],Lx[i],Ly[i],x[i+1],y[i+1]);
    }
